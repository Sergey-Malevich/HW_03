...
from dotenv import load_dotenv # Для хранения паролей, секретных ключей и т.д.
...
LOGIN_URL = '/accounts/login/'            #  url перенаправления не авторизованного пользователя
LOGIN_REDIRECT_URL = 'news_list'   # url перенаправления после входа
...
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'  # подтверждение почты
